        ...
        <div className="grid md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="space-y-4 text-sm">
              ...
              <a href="tel:+493025730875" className="flex items-start gap-3 hover:text-slate-300 transition-colors group">
                <svg className="w-5 h-5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <span className="group-hover:underline">+49 30 25730875</span>
              </a>
              <div className="flex items-start gap-3 text-slate-400">
                ...
                <span>Perleberger Str. 41<br/>10559 Berlin, Germany</span>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <a href="mailto:info@medicalcaregermany.com" className="inline-block">
