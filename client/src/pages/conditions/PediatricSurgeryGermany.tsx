...
const WA_LINK =
  "https://wa.me/4917647757767?text=%D9%85%D8%B1%D8%AD%D8%A8%D8%A7%2C%20%D8%A3%D9%88%D8%AF%20%D8%A5%D8%B1%D8%B3%D8%A7%D9%84%20%D9%85%D9%84%D9%81%D9%8A%20%D8%A7%D9%84%D8%B7%D8%A8%D9%8A%20%D9%84%D9%84%D8%AA%D9%82%D9%8A%D9%8A%D9%85";

const CASES = [
  "التشوهات الخلقية التي تحتاج تصحيحًا جراحيًا",
  "الحالات الجراحية المعقدة في الجهاز الهضمي",
  "جراحة القلب الخلقية عند الأطفال",
  "الجراحة التصحيحية للعظام عند الأطفال",
  "الأورام الجراحية عند الأطفال",
  "الحالات الطارئة بعد الحوادث",
  "إعادة التقييم بعد عمليات سابقة",
  "الجراحة التنظيرية المتقدمة عند الأطفال",
];

const PATHWAY = [
  { n: "01", title: "مراجعة الملف الطبي والأشعة", body: "تحليل التقارير والفحوصات والتاريخ الجراحي للطفل." },
  { n: "02", title: "التنسيق مع جراح الأطفال المختص", body: "ربط الحالة بالجراح المناسب في المستشفى الجامعي." },
  { n: "03", title: "التقييم السريري والجراحي", body: "فحص مباشر وتصوير متقدم وتقرير جراحي تفصيلي." },
  { n: "04", title: "خطة الجراحة والتأهيل", body: "تحديد المسار الجراحي وتنسيق مرحلة التعافي." },
];
...
const DOCS = [
  ...
  "أشعة MRI أو CT حديثة",
  "تقارير العمليات السابقة إن وجدت",
  "وصف الأعراض وتاريخ الحالة",
  "قائمة الأدوية الحالية",
];

export default function PediatricSurgeryGermany() {
  return (
    <div dir="rtl" style={{ ...AR, background: "#fff", color: "#1a1a2e" }}>
      ...
      <section style={{ background: "#0B1C2C", padding: "64px 24px", borderTop: "1px solid #1e3a52" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <h2 style={{ ...AR, fontSize: "clamp(18px, 2.5vw, 26px)", fontWeight: 500, color: "#f8fafc", marginBottom: 20, lineHeight: 1.55 }}>
            القرار الجراحي عند الأطفال يحتاج تقييمًا دقيقًا
          </h2>
          <p style={{ ...AR, fontSize: 15, color: "#94a3b8", lineHeight: 1.9, marginBottom: 20 }}>
            الجراحة عند الأطفال تختلف في متطلباتها وتقنياتها عن جراحة البالغين. التقييم الدقيق من جراح أطفال متخصص هو الخطوة الأولى الصحيحة قبل اتخاذ أي قرار جراحي.
          </p>
          <p style={{ ...AR, fontSize: 15, color: "#64748b", lineHeight: 1.9, marginBottom: 32 }}>
            يعمل فريقنا على تنسيق التقييم الجراحي مع جراحي الأطفال المتخصصين في ألمانيا، مع مراجعة كاملة للتاريخ الطبي والتقارير السابقة.
          </p>
      ...
      <section style={{ background: "#f8fafc", padding: "72px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 40, textAlign: "center", lineHeight: 1.5 }}>
            حالات جراحة الأطفال التي نُنسِّق تقييمها
          </h2>
      ...
      <section style={{ padding: "72px 24px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 40, lineHeight: 1.5 }}>
          كيف نُنسِّق الحالة الجراحية للطفل في ألمانيا
        </h2>
