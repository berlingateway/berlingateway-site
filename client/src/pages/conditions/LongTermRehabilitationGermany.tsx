 ...
 * Arabic Authority Page — Long-Term Rehabilitation Germany
 */
...
const CASES = [
  "إصابات الحبل الشوكي والشلل الجزئي أو الكامل",
  "إصابات الدماغ الرضية المزمنة",
  "البتر وإعادة التأهيل الحركي المستمر",
  "الألم المزمن المقاوم للعلاج",
  "مضاعفات الجراحة التي تحتاج متابعة مطولة",
  "الحالات التي تحتاج استمرارية علاجية بعد المرحلة الحادة",
  "التأهيل متعدد التخصصات طويل المدى",
];

const PATHWAY = [
  { n: "01", label: "تقييم الحالة الحالية ومراحل التأهيل السابقة" },
  { n: "02", label: "تحديد الأهداف التأهيلية طويلة المدى" },
  { n: "03", label: "التنسيق مع مراكز التأهيل المتخصصة في ألمانيا" },
  { n: "04", label: "بناء خطة تأهيل مستمرة ومرنة" },
  { n: "05", label: "المتابعة الدورية وتعديل الخطة وفق التقدم" },
];

const DOCUMENTS = [
  "تقارير التأهيل السابقة",
  "التقييمات الوظيفية الحالية",
  "صور الأشعة والتقارير الطبية الأخيرة",
  "وصف الأهداف التأهيلية المرجوة",
  "قائمة الأدوية والعلاجات الجارية",
];

export default function LongTermRehabilitationGermany() {
  return (
    <div dir="rtl" style={{ ...AR, background: "#fff", color: "#1a1a2e" }}>
      <SmartNavLayer currentPath="/ar/long-term-rehabilitation-germany" />
      <HreflangTags currentPath="/ar/long-term-rehabilitation-germany" />
      <title>العلاج التأهيلي طويل المدى في ألمانيا | استمرارية التأهيل المتخصص</title>
      <meta
        name="description"
        content="تنسيق برامج التأهيل طويلة المدى في ألمانيا — إصابات الحبل الشوكي، الدماغ، البتر، الألم المزمن، والحالات التي تحتاج استمرارية علاجية متخصصة."
      />
      ...
      <section style={{ background: "#0B1C2C", padding: "80px 24px 72px", textAlign: "center" }}>
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          <p style={{ ...AR, fontSize: 11, letterSpacing: "0.18em", color: "#94a3b8", textTransform: "uppercase", marginBottom: 20 }}>
            Medical Care Germany — استمرارية التأهيل الطبي
          </p>
          <h1 style={{ ...AR, fontSize: "clamp(26px, 4vw, 40px)", fontWeight: 500, color: "#f8fafc", lineHeight: 1.45, marginBottom: 20 }}>
            العلاج التأهيلي طويل المدى في ألمانيا
          </h1>
          <p style={{ ...AR, fontSize: 16, color: "#94a3b8", lineHeight: 1.85, maxWidth: 620, margin: "0 auto 36px" }}>
            تنسيق برامج التأهيل المستمرة للحالات التي تحتاج متابعة علاجية مطولة، ضمن مراكز التأهيل الألمانية المتخصصة.
          </p>
      ...
      <section style={{ padding: "72px 24px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 24, lineHeight: 1.5 }}>
          التأهيل ليس مرحلة واحدة
        </h2>
        <p style={{ ...AR, fontSize: 15, color: "#475569", lineHeight: 1.9, marginBottom: 20 }}>
          بعض الحالات المعقدة تحتاج إلى برامج تأهيل مستمرة تمتد لأشهر أو سنوات، مع تعديل مستمر للخطة العلاجية وفق تطور الحالة السريرية واستجابة المريض للعلاج.
        </p>
        <p style={{ ...AR, fontSize: 15, color: "#475569", lineHeight: 1.9 }}>
          في ألمانيا، تتوفر مراكز متخصصة في التأهيل طويل المدى تقدم برامج متكاملة تجمع بين التأهيل الحركي، العلاج الطبيعي المستمر، الدعم النفسي، وإعادة التأهيل المهني.
        </p>
      ...
      <section style={{ background: "#f8fafc", padding: "72px 24px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 32, lineHeight: 1.5 }}>
            كيف يتم تنسيق التأهيل طويل المدى؟
          </h2>
          {PATHWAY.map((step) => (
