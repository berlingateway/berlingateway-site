...
يمكن إرسال التقارير الطبية للحصول على تقييم أولي قبل اتخاذ أي قرار علاجي.`}
        ...
        deepDive={{
          title: "تفاصيل إضافية: أنواع الأورام والبروتوكولات العلاجية",
          content: [
        ...
        gdprNote="جميع الوثائق تُعالَج وفق أنظمة حماية البيانات الألمانية (DSGVO)."
