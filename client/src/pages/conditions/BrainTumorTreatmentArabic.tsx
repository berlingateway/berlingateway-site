  ...
  return (
    <>
      ...
      <MedicalConditionPage
        ...
        heroEyebrow="رأي طبي ثانٍ في أورام المخ · برلين · ألمانيا"
        headline="عندما يكون القرار مصيرياً… نحدد المسار الصحيح قبل فوات الوقت"
        subtitle="كثير من الحالات التي وصلتنا بتشخيص ورم — احتاجت مراجعة كاملة قبل أي قرار جراحي أو إشعاعي.
نراجع ملفك مع فريق Tumor Board متخصص في المستشفيات الجامعية الألمانية."
        ...
        patientTestimonials={{
          stories: [
            {
              text: "مريض من ليبيا، ٥١ عاماً — تشخيص أولي بورم في المخ وقرار بجراحة عاجلة في بلده.\nبعد مراجعة الملف مع فريق Tumor Board في برلين، تبيّن أن الورم من النوع الذي يستجيب للعلاج الإشعاعي أولاً بدون جراحة.\nبدأ البروتوكول العلاجي — والجراحة أصبحت خياراً ثانياً لا أولاً.",
            },
            {
              text: "مريضة من الجزائر، ٤٥ عاماً — صداع مستمر ونوبة تشنج للمرة الأولى. تشخيصات متضاربة بين أطباء.\nبعد التصوير بالرنين المتقدم وتحليل الخزعة في برلين، تحدد نوع الورم ودرجته بدقة.\nوُضع بروتوكول علاجي مخصص — بدأت تتحسن خلال الأسابيع الأولى.",
            },
          ],
