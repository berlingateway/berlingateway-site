 ...
 * Arabic Authority Page — Prosthetics & Mobility Restoration Germany
 */
...
const CASES = [
  "بتر الأطراف السفلية بعد الحوادث أو الأمراض",
  "بتر الأطراف العلوية",
  "إصابات الحرب والنزاعات المسلحة",
  "مضاعفات السكري المؤدية إلى البتر",
  "الحاجة إلى إعادة تركيب أو تحديث الطرف الصناعي",
  "الألم المزمن بعد البتر (متلازمة الطرف الوهمي)",
  "تقييم ثانٍ لخطة التأهيل الحالية",
];

const PATHWAY = [
  { n: "01", label: "تقييم الحالة الجراحية والوظيفية الحالية" },
  { n: "02", label: "التنسيق مع متخصصي الأطراف الصناعية" },
  { n: "03", label: "تحديد نوع الطرف الصناعي المناسب (ميكانيكي / إلكتروني / روبوتي)" },
  { n: "04", label: "بناء خطة التأهيل الحركي والوظيفي" },
  { n: "05", label: "المتابعة وإعادة التقييم الدوري" },
];

const DOCUMENTS = [
  "تقارير الجراحة أو البتر",
  "صور الأشعة أو MRI للطرف المتبقي",
  "وصف القيود الحركية الحالية",
  "قائمة الأدوية والعلاجات الجارية",
  "تقرير التأهيل السابق إن وجد",
];

export default function ProstheticsGermany() {
  return (
    <div dir="rtl" style={{ ...AR, background: "#fff", color: "#1a1a2e" }}>
      ...
      <section style={{ padding: "72px 24px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 24, lineHeight: 1.5 }}>
          الطرف الصناعي ليس الخطوة الأخيرة
        </h2>
        <p style={{ ...AR, fontSize: 15, color: "#475569", lineHeight: 1.9, marginBottom: 20 }}>
          تركيب الطرف الصناعي هو بداية مسار التأهيل الحركي، وليس نهايته. النجاح الوظيفي يعتمد على التوافق الدقيق بين نوع الطرف الصناعي، حالة الطرف المتبقي، القدرة الحركية، وبرنامج التأهيل المصاحب.
        </p>
        <p style={{ ...AR, fontSize: 15, color: "#475569", lineHeight: 1.9 }}>
          في ألمانيا، تتوفر تقنيات الأطراف الصناعية الروبوتية والإلكترونية المتقدمة، إلى جانب برامج تأهيل حركي مكثفة تهدف إلى استعادة الاستقلالية الوظيفية الكاملة.
        </p>
