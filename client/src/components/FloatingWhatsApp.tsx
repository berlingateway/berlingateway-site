/**
 * FloatingWhatsApp
 * A fixed floating button in the lower-right corner that opens WhatsApp.
 * Rendered globally in App.tsx — no layout changes required on individual pages.
 */
export default function FloatingWhatsApp() {
  const phone = "4915781497451";
  const message = encodeURIComponent("Hello, I would like to speak with a Medical Coordinator.");
