...
export default function NeurologyTreatment() {
  return (
    <MedicalConditionPage
      ...
      arabicSummary="أمراض الجهاز العصبي تشمل طيفاً واسعاً من الحالات، منها الجلطة، والتصلب اللويحي، والصرع، واضطرابات الحركة، والأمراض المناعية التي تصيب الجهاز العصبي. كثير من هذه الحالات تتطلب تشخيصاً دقيقاً باستخدام أجهزة تصوير متقدمة وفحوصات تخصصية. توفر مستشفيات ألمانيا الجامعية أجهزة رنين مغناطيسي متطورة ومختبرات فيزيولوجيا عصبية متخصصة تتيح تشخيصاً دقيقاً للحالات المعقدة. يمكن إرسال التقارير للتقييم الأولي قبل اتخاذ أي خطوة علاجية."
    />
  );
}
