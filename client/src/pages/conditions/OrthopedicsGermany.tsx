...
const ORTHO_FAQ_JSONLD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "يعتمد القرار على درجة التآكل، العمر، مستوى النشاط، وصور الرنين المغناطيسي. في الحالات المبكرة يمكن العلاج بالحقن المفصلي أو العلاج الفيزيائي. في الحالات المتقدمة (الدرجة الثالثة–الرابعة) تكون زراعة المفصل الخيار الأمثل.",
      },
    },
    {
      "@type": "Question",
...
const JOINT_REPLACEMENT = [
  {
    joint: "مفصل الركبة",
    indication: "تآكل الدرجة الثالثة–الرابعة، ألم مزمن، تقييد الحركة",
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "يعتمد القرار على درجة التآكل، العمر، مستوى النشاط، وصور الرنين المغناطيسي. في الحالات المبكرة يمكن العلاج بالحقن المفصلي أو العلاج الفيزيائي. في الحالات المتقدمة (الدرجة الثالثة–الرابعة) تكون زراعة المفصل الخيار الأمثل.",
  },
  {
