...
const SITUATIONS = [
  "تشخيص سرطان القولون مؤكد وتريد رأياً ثانياً",
  "التقارير غير حاسمة في تحديد المرحلة",
  "قيل لك إن الجراحة الكبرى ضرورية",
  "العلاج الكيميائي لم يعطِ نتيجة",
  "الورم في موضع معقد يحتاج جراحة دقيقة",
  "تريد تقييم الجراحة الروبوتية (دافنشي)",
  "تريد بروتوكول علاجي من مركز أكاديمي",
  "الحالة تشمل انتشاراً للكبد أو الرئة",
];

const WHY_CARDS = [
  {
    title: "جراحة روبوتية دافنشي — دقة عالية وتعافٍ أسرع",
    body: "تقنية دافنشي الروبوتية متاحة في مراكز متخصصة في برلين وتوفر دقة أعلى في الجراحة وتعافياً أسرع مقارنة بالجراحة التقليدية",
  },
  {
    title: "تقييم انتشار الورم للكبد والرئة بتقنيات متقدمة",
    body: "الانتشار للكبد لا يعني استحالة العلاج — فريق متخصص يُقيّم كل حالة بتقنيات تصوير متقدمة لتحديد الخيار الأنسب",
  },
  {
    title: "فريق متكامل — جراحة وأورام وأشعة تداخلية",
    body: "كل حالة تُناقَش في لجنة متعددة التخصصات — جراح القولون وطبيب الأورام وأخصائي الأشعة التداخلية",
  },
];

const FAQ_DATA = [
  {
    q: "هل الجراحة الروبوتية لسرطان القولون متاحة في ألمانيا؟",
    a: "نعم — تقنية دافنشي الروبوتية متاحة في مراكز متخصصة في برلين وتوفر دقة أعلى وتعافياً أسرع.",
  },
  {
    q: "هل يمكن علاج سرطان القولون إذا انتشر للكبد؟",
    a: "في حالات كثيرة نعم — الانتشار للكبد لا يعني استحالة العلاج، ويُقيَّم من فريق متخصص مشترك.",
  },
  {
    q: "ما الفرق بين سرطان القولون وسرطان المستقيم في التشخيص؟",
    a: "موضع الورم يحدد البروتوكول الجراحي والعلاجي — التمييز الدقيق ضروري قبل أي قرار.",
  },
  {
    q: "كيف أرسل ملفي لتقييم حالة سرطان القولون؟",
    a: "أرسل التقارير والأشعة عبر الموقع أو واتساب — منسق يرد خلال 24 ساعة.",
  },
  {
    q: "هل العلاج الكيميائي قبل الجراحة خيار في ألمانيا؟",
    a: "نعم — العلاج الكيميائي قبل الجراحة (Neoadjuvant) خيار متاح في حالات كثيرة لتقليص الورم قبل التدخل الجراحي.",
  },
];
...
const MEDICAL_WEBPAGE_SCHEMA = {
  "@context": "https://schema.org",
  "@type": "MedicalWebPage",
  name: "سرطان القولون في ألمانيا | جراحة متخصصة وتقييم شامل",
  description:
  ...
  url: "https://medicalcaregermany.com/ar/colon-cancer-treatment-germany",
  inLanguage: "ar",
...
export default function ColonCancerArabic() {
  ...
  useEffect(() => {
    ...
    c.href = "https://medicalcaregermany.com/ar/colon-cancer-treatment-germany";
  }, []);

  return (
    <div dir="rtl" style={{ ...AR, background: "#fff", color: "#1a1a2e" }}>
      <SmartNavLayer currentPath="/ar/colon-cancer-treatment-germany" />
      <HreflangTags currentPath="/ar/colon-cancer-treatment-germany" />
      ...
      <section style={{ background: "#0B1C2C", padding: "80px 24px 72px", textAlign: "center" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <h1 style={{ ...AR, fontSize: "clamp(26px, 4vw, 42px)", fontWeight: 500, color: "#f8fafc", lineHeight: 1.55, marginBottom: 24 }}>
            سرطان القولون في ألمانيا
            <br />
            قبل الجراحة — تقييم متخصص في برلين.
          </h1>
          <p style={{ ...AR, fontSize: 16, color: "#94a3b8", lineHeight: 1.9, maxWidth: 620, margin: "0 auto 36px" }}>
            سرطان القولون يحتاج تقييماً دقيقاً قبل اختيار الجراحة أو العلاج الكيميائي.
            <br />
            ألمانيا تملك تقنيات جراحية متقدمة تحافظ على أكبر قدر من جودة الحياة.
          </p>
      ...
      <section style={{ padding: "72px 24px 64px", background: "#0B1C2C", textAlign: "center" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <h2 style={{ ...AR, fontSize: "clamp(18px, 2.8vw, 28px)", fontWeight: 500, color: "#f8fafc", lineHeight: 1.6, marginBottom: 32 }}>
            "أجرينا العملية بتقنية دافنشي الروبوتية في الشاريتي"
          </h2>
          <p style={{ ...AR, fontSize: 15, color: "#94a3b8", lineHeight: 2, maxWidth: 640, margin: "0 auto 32px" }}>
            مريض ليبي — ورم في القولون في موضع معقد.
            <br />
            في بلده قالوا إن الجراحة التقليدية الكبرى ضرورية.
            <br />
            أرسل ملفه إلينا.
            <br /><br />
            في الشاريتي برلين — تمت العملية بتقنية
            <br />
            دافنشي الروبوتية — أدق وأقل توغلاً.
            <br />
            تعافٍ أسرع. وعودة للحياة الطبيعية خلال أسابيع.
          </p>
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.12)", paddingTop: 24 }}>
            <p style={{ ...AR, fontSize: 16, color: "#f8fafc", fontWeight: 500, lineHeight: 1.7 }}>
              التقنية الصحيحة تغيّر مسار التعافي.
            </p>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: "72px 24px 64px", background: "#fff" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          <h2 style={{ ...AR, fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 500, color: "#0B1C2C", lineHeight: 1.5, marginBottom: 48, textAlign: "center" }}>
            لماذا ألمانيا لعلاج سرطان القولون؟
          </h2>
