...
export default function NeurologyTreatment() {
  return (
    <>
      ...
      relatedLinks={[
        { href: "/neurology-germany", label: "Neurology Hub" },
