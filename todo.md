# Medical Care Germany - Website Upgrade TODO

## Strategic Positioning Upgrade
- [x] Update hero section with institutional positioning
- [x] Add Elite Entry Filter below hero
- [x] Integrate Group Authority (Merlin Medical Care Group/BMC)
- [x] Add Government-Aligned Trust Language
- [x] Add Geographic Trust Signal
- [x] Create WHO WE TYPICALLY SUPPORT section
- [x] Create ROLE CLARITY section (4 pillars)
- [x] Add 3 confidential case narratives
...
- [x] Set email target to info@medicalcaregermany.com
...
- [x] Form sends directly to FormSubmit.co → info@medicalcaregermany.com (no React, no tRPC, no backend)
