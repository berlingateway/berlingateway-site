...
import NeckPainDizzinessArabic from "./pages/conditions/NeckPainDizzinessArabic";
...
import LiverCancerArabic from "./pages/conditions/LiverCancerArabic";
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path={"/ar/neck-pain-dizziness-germany"} component={NeckPainDizzinessArabic} />
      ...
      <Route path={"/ar/liver-cancer-treatment-germany"} component={LiverCancerArabic} />
