...
const conditions = [
  { href: "/spine-surgery-germany", en: "Spine Surgery", ar: "جراحة العمود الفقري" },
  { href: "/herniated-disc-treatment-germany", en: "Herniated Disc", ar: "الانزلاق الغضروفي" },
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans">
      ...
      <section className="py-20 px-6 max-w-4xl mx-auto">
        ...
        <h1 className="text-4xl font-serif font-medium text-slate-900 mb-4">Spine Treatment in Germany</h1>
        <p className="text-lg text-slate-500 font-light mb-8 max-w-2xl">
          Specialist spinal evaluation and surgery at German university hospitals for complex conditions of the vertebral column and intervertebral structures.
        </p>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-sm p-6 mb-12 text-right" dir="rtl" style={{ fontFamily: "'IBM Plex Sans Arabic', Cairo, sans-serif" }}>
          <h2 className="text-base font-semibold text-slate-800 mb-3">علاج العمود الفقري في ألمانيا</h2>
          <p className="text-sm text-slate-600 leading-relaxed">
            تشمل أمراض العمود الفقري الانزلاق الغضروفي، وتضيق القناة الشوكية، والجنف، وغيرها من الحالات التي تؤثر على الحركة وجودة الحياة. تتوفر في ألمانيا مراكز جراحة عمود فقري جامعية متخصصة تعتمد على تقنيات تصوير متقدمة وأنظمة توجيه جراحي دقيقة. يمكن إرسال التقارير الطبية للتقييم الأولي قبل اتخاذ أي قرار جراحي.
          </p>
        </div>

        <h2 className="text-xl font-serif text-slate-800 mb-6">Spinal Conditions</h2>
        ...
        <div className="border-t border-slate-100 pt-10 text-center">
          <p className="text-slate-500 text-sm mb-6">Medical reports may be submitted for specialist review. A Berlin-based coordinator will assess the case and identify the appropriate spinal specialist.</p>
