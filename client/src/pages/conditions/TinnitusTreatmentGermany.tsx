...
const CASES = [
  "الطنين المزمن المستمر في إذن واحدة أو كلتيهما",
  "الطنين المرتبط بفقدان السمع",
  "الطنين بعد التعرض للضوضاء الشديدة أو الانفجارات",
  "الطنين المرتبط بمرض مينيير",
  "الطنين الناجم عن أدوية أو علاج كيميائي",
  "الطنين المرتبط باضطرابات الفك والمفصل الصدغي الفكي",
  "الطنين المصحوب بدوار أو اضطرابات توازن",
  "الطنين المقاوم للعلاج المحلي",
];

const PATHWAY = [
  { n: "01", title: "مراجعة التاريخ الطبي والأشعة", body: "تحليل التقارير السمعية والفحوصات السابقة وتحديد النوع والسبب." },
  { n: "02", title: "التنسيق مع مختص الطنين", body: "ربط الحالة بطبيب الأنف والأذن والحنجرة المتخصص في اضطرابات الطنين." },
  { n: "03", title: "التقييم السمعي والعصبي", body: "اختبارات سمعية متقدمة مع تصوير الرنين المغناطيسي لاستبعاد الأسباب العضوية." },
  { n: "04", title: "خطة العلاج المتكاملة", body: "تحديد البروتوكول العلاجي — صوتي، دوائي، نفسي، أو تدخلي." },
  { n: "05", title: "المتابعة والتأهيل", body: "تنسيق المتابعة طويلة المدى وبرامج إعادة التأهيل السمعي." },
];
...
export default function TinnitusTreatmentGermany() {
  return (
    <div dir="rtl" style={{ ...AR, background: "#fff", color: "#1a1a2e" }}>
      ...
      <title>علاج الطنين وطنين الأذن في ألمانيا | تقييم الحالات المزمنة</title>
      <meta
        name="description"
        content="تقييم وتنسيق علاج الطنين المزمن وطنين الأذن في ألمانيا — الطنين المستمر، المرتبط بفقدان السمع، أو الناجم عن الصدمات والانفجارات."
      />
      ...
      <section style={{ background: "#0B1C2C", padding: "72px 24px 64px", textAlign: "center" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <p style={{ ...AR, fontSize: 11, letterSpacing: "0.18em", color: "#94a3b8", textTransform: "uppercase", marginBottom: 20 }}>
            Medical Care Germany — Tinnitus-Behandlung
          </p>
          ...
          <p style={{ ...AR, fontSize: 16, color: "#94a3b8", lineHeight: 1.85, maxWidth: 640, margin: "0 auto 32px" }}>
            تقييم وتنسيق حالات الطنين المزمن في ألمانيا — من التشخيص الدقيق لتحديد السبب، إلى خطة العلاج المتكاملة بالتنسيق مع المختصين الألمان.
          </p>
      ...
      <section style={{ background: "#f8fafc", padding: "64px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 36, textAlign: "center", lineHeight: 1.5 }}>
            حالات الطنين التي نُنسِّق تقييمها وعلاجها
          </h2>
      ...
      <section style={{ background: "#0B1C2C", padding: "64px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: 640, margin: "0 auto" }}>
          ...
          <p style={{ ...AR, fontSize: 14, color: "#94a3b8", lineHeight: 1.85, marginBottom: 32 }}>
            أرسل التقارير السمعية والطبية الحالية. التقييم الأولي يحدد إمكانية التنسيق مع مختص الطنين في ألمانيا.
          </p>
