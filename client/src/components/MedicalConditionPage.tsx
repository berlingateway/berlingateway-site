...
export default function MedicalConditionPage({
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans" dir={pageDir}>
      ...
      {/* Hero */}
      <header className="bg-slate-50 border-b border-slate-200 py-10 md:py-20 px-6">
      ...
      <main className="max-w-5xl mx-auto px-6 py-10 md:py-20 space-y-10 md:space-y-14 pb-28 md:pb-20">
