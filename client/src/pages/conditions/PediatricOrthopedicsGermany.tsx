...
const CASES = [
  "التشوهات الخلقية في العظام والمفاصل",
  "الجنف والتشوهات في العمود الفقري عند الأطفال",
  "الكسور المعقدة وما بعد الجراحة",
  "تشوهات القدم والساق",
  "اضطرابات النمو العظمي",
  "الجراحة التصحيحية للأطراف",
  "إعادة التأهيل بعد جراحة العظام",
  "الحالات المعقدة بعد الحوادث",
];

const PATHWAY = [
  { n: "01", title: "مراجعة الأشعة والتقارير", body: "تحليل الأشعة والتاريخ الطبي والجراحي للطفل." },
  { n: "02", title: "التنسيق مع طبيب عظام الأطفال", body: "ربط الحالة بالمختص المناسب في المستشفى الجامعي." },
  { n: "03", title: "التقييم السريري والجراحي", body: "فحص مباشر وتصوير متقدم وتقرير تخصصي." },
  { n: "04", title: "خطة العلاج والتأهيل", body: "تحديد المسار العلاجي وتنسيق مرحلة التعافي." },
];
...
const DOCS = [
  "أشعة MRI أو CT أو X-Ray حديثة",
  "تقرير طبي من الطبيب المعالج الحالي",
  "تقارير العمليات السابقة إن وجدت",
  "وصف الأعراض وتاريخ الحالة",
  "عمر الطفل وتاريخ الولادة",
];

export default function PediatricOrthopedicsGermany() {
  return (
    <div dir="rtl" style={{ ...AR, background: "#fff", color: "#1a1a2e" }}>
      ...
      <section style={{ background: "#0B1C2C", padding: "64px 24px", borderTop: "1px solid #1e3a52" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <h2 style={{ ...AR, fontSize: "clamp(18px, 2.5vw, 26px)", fontWeight: 500, color: "#f8fafc", marginBottom: 20, lineHeight: 1.55 }}>
            تشوهات العظام عند الأطفال تحتاج تقييمًا مبكرًا ودقيقًا
          </h2>
          <p style={{ ...AR, fontSize: 15, color: "#94a3b8", lineHeight: 1.9, marginBottom: 20 }}>
            حالات العظام عند الأطفال تختلف في طبيعتها وتطورها عن البالغين. التدخل المبكر والتقييم الدقيق من مختص ألماني في عظام الأطفال يمكن أن يحدث فرقًا كبيرًا في مسار العلاج.
          </p>
          <p style={{ ...AR, fontSize: 15, color: "#64748b", lineHeight: 1.9, marginBottom: 32 }}>
            يعمل فريقنا على تنسيق التقييم مع أطباء عظام الأطفال المتخصصين في ألمانيا، مع مراجعة كاملة للتاريخ الطبي والأشعة.
          </p>
      ...
      <section style={{ background: "#f8fafc", padding: "72px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 40, textAlign: "center", lineHeight: 1.5 }}>
            حالات عظام الأطفال التي نُنسِّق تقييمها
          </h2>
      ...
      <section style={{ padding: "72px 24px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 40, lineHeight: 1.5 }}>
          كيف نُنسِّق حالة عظام الطفل في ألمانيا
        </h2>
