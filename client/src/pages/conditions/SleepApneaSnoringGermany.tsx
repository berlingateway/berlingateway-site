 ...
 * الشخير وانقطاع النفس أثناء النوم في ألمانيا
 */
...
const CASES = [
  "انقطاع النفس الانسدادي أثناء النوم (OSAS) الشديد",
  "الشخير المزمن المرتبط بانسداد مجرى الهواء",
  "انقطاع النفس المقاوم لأجهزة CPAP",
  "الحالات التي تحتاج إلى تقييم جراحي",
  "انقطاع النفس المرتبط بانحراف الحاجز الأنفي",
  "انقطاع النفس المرتبط بتضخم اللوزتين أو اللحمية",
  "الحالات المصحوبة باضطرابات قلبية أو تنفسية",
  "انقطاع النفس عند الأطفال",
];

const PATHWAY = [
  { n: "01", title: "مراجعة التقارير ونتائج دراسة النوم", body: "تحليل نتائج تخطيط النوم (Polysomnographie) وتقارير الطبيب المعالج." },
  { n: "02", title: "التنسيق مع مختص اضطرابات النوم", body: "ربط الحالة بطبيب الأنف والأذن والحنجرة أو مختص اضطرابات النوم في ألمانيا." },
  { n: "03", title: "التقييم السريري الشامل", body: "فحص مجرى الهواء العلوي وتحديد موضع الانسداد ودرجة الشدة." },
  { n: "04", title: "خطة العلاج", body: "تحديد الخيار الأنسب — جراحي، أجهزة تنفسية، أو علاج تحفظي." },
  { n: "05", title: "المتابعة بعد العلاج", body: "تنسيق المتابعة وتقييم فاعلية العلاج بعد التدخل." },
];
    ...
    <div dir="rtl" style={{ ...AR, background: "#fff", color: "#1a1a2e" }}>
      ...
      <section style={{ background: "#0B1C2C", padding: "72px 24px 64px", textAlign: "center" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          <p style={{ ...AR, fontSize: 11, letterSpacing: "0.18em", color: "#94a3b8", textTransform: "uppercase", marginBottom: 20 }}>
            Medical Care Germany — Schlafapnoe & Schnarchen
          </p>
      ...
      <section style={{ background: "#f8fafc", padding: "64px 24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 36, textAlign: "center", lineHeight: 1.5 }}>
            حالات اضطرابات النوم التنفسية التي نُنسِّق تقييمها
          </h2>
      ...
      <section style={{ padding: "64px 24px", maxWidth: 760, margin: "0 auto" }}>
        ...
        <h2 style={{ ...AR, fontSize: "clamp(20px, 3vw, 28px)", fontWeight: 500, color: "#0B1C2C", marginBottom: 36, lineHeight: 1.5 }}>
          كيف نُنسِّق حالات انقطاع النفس أثناء النوم
        </h2>
